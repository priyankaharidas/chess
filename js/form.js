...
(function(d){
	...
	/<span style="color:red">*</span> Util methods <span style="color:red">*</span>/
	H5F.listen = function (node,type,fn,capture) {
		if(H5F.isHostMethod(window,"addEventListener")) {
			/<span style="color:red">*</span> FF & Other Browsers <span style="color:red">*</span>/
			node.addEventListener( type, fn, capture );
		} else if(H5F.isHostMethod(window,"attachEvent") && typeof window.event !== "undefined") {
			/<span style="color:red">*</span> Internet Explorer way */
			if(type === "blur") {
				type = "focusout";
			} else if(type === "focus") {
				type = "focusin";
